...
def main(output_path: Path) -> None:
    ...
    rows = [
        ...
        {"condition": "replace_C=+2", "metrics": metrics(
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", type=Path, default=Path("slop/research/spider_dog_c2_trial.json"))
