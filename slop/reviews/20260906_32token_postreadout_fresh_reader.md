...
- **Correct:** The text does not claim that dog identity was transferred. Both artifacts state that `C=1` is the constructed replacement, while displayed `C=4` is an extrapolation (`README.md:202-206`; `nbs/demo.ipynb:14-16`).
